...
$select_prefijo="SELECT manual_dial_prefix as prefijo from vicidial_campaigns where campaign_id='0011'";
...
echo"<button type=\"button\" class=\"btn btn-warning\" style=\"width: 120px; height: 60px;\">$prefijo</button>";
...
echo"<button type=\"button\" class=\"btn btn-success\" style=\"width: 120px; height: 60px;\">$prefijo</button>";

}else if($prefijo=='9'){

 echo"<button type=\"button\" class=\"btn btn-info\" style=\"width: 120px; height: 60px;font-size:25px;\">$prefijo</button>";
